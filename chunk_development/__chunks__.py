...
from WSEChunks import WSEChunks
...
def main() -> None:
    ...
    out_directory = r"C:\Users\jacob.bates\OneDrive - WSP O365\2d_floodway_testing\future_floodway\testing_outputs\chunks"
    ...
    for me in mesh_areas:
        ...
        me.trace_backwater_chunks()
        me.backwater_chunks_to_shapefile(scoped_stream_network, out_directory)
